                            ...
                            <div class="panel-body">
                                <div class="dataTable_wrapper">
                                    <table class="table table-striped table-bordered table-hover display" id="dataTables" style="width: 100%">
                                        ...
                                        $sql = "SELECT id_Pelanggan AS 'Id', CONCAT(Nama_Depan,' ',Nama_Belakang) AS 'Nama', kode_pos AS 'Kode POS', Alamat, No_HP AS 'No. HP', Email, username AS 'Username'
                                            FROM daftar_pelanggan";
